...
--------------VEHICLE HORN ON SIREN----------------
siren_horn_confirm_enabled = true
--	Plays a horn sound when the MAIN siren is started, when the tone / stage is changed, and when the siren is stopped.
siren_horn_volume = 0.6
--	Volume (0.0 - 1.0) for the horn sounds below.
siren_horn_start_sound = 'horn/CarHornOff.wav'
--	Sound played when the siren is STARTED or the tone / stage is CHANGED. Path is relative to `lvc/UI/sounds/` and MUST include the file extension.
siren_horn_stop_sound = 'horn/CarHornOff2.wav'
--	Sound played when the siren is STOPPED.
siren_horn_hear_distance = 80.0
--	Maximum distance, in metres, at which nearby players can hear another player's horn. Volume fades to silence over this range.


-----------------CVS LIGHT CONTROLLER--------------
cvs_display_label = '999'
...
cvs_sound_scene = 'cvs/sceneMode.wav'
--	Sound played when At Scene mode is engaged.
cvs_sound_action = 'cvs/optilink.wav'
--	Sound played for individual light switches.
cvs_sound_leave = 'cvs/optilink.wav'
--	Sound played when cancelling / leaving a mode (e.g. cycling back to off).
